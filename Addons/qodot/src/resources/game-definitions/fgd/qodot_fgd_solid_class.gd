...
@export var spawn: String : String = QodotUtil.CATEGORY_STRING
@export var spawn_type: SpawnType : int = SpawnType.ENTITY

# Controls how visuals are built for this SolidClass
@export var visual_build: String : String = QodotUtil.CATEGORY_STRING
@export var build_visuals: bool := true

# Controls how collisions are built for this SolidClass
@export var collision_build: String : String = QodotUtil.CATEGORY_STRING
@export var collision_shape_type: CollisionShapeType : int = CollisionShapeType.CONVEX
